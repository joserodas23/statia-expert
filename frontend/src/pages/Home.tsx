...
const EJEMPLOS = [
  ...
  // ── 🔬 REGLAS CLÁSICAS + MYCIN — Diagnóstico de Parvovirosis Canina ──────
  // 24 indicadores clínicos y epidemiológicos. Reglas que comparten conclusión
  // se combinan con MYCIN: CF_final = CF1 + CF2*(1-CF1).
  { nombre: 'Diagnóstico Presuntivo de Parvovirosis Canina (CPV)', tipo_motor: 'crisp',
    dominio: 'Veterinaria', usar_mycin: true,
    descripcion: 'Evalúa 24 indicadores clínicos, epidemiológicos y analíticos para estimar el nivel de sospecha de Parvovirus Canino (CPV-2). Combina evidencias múltiples con la fórmula MYCIN: CF = CF1 + CF2*(1−CF1).',
    hechos_ejemplo: {
      cachorro: 'si', no_vacunado: 'si', vacunado_hace_menos_14_dias: 'no',
      vomito: 'si', diarrea_hemorragica: 'si', diarrea_fetida: 'no',
      letargia: 'si', anorexia: 'si', fiebre_alta: 'si', dolor_abdominal: 'si',
      deshidratacion_severa: 'si', edad_6sem_a_6meses: 'si',
      leucopenia_severa: 'si', linfopenia: 'si', neutropenia: 'si',
      hipoglucemia: 'no', hipoalbuminemia: 'no',
      antigeno_fecal_positivo: 'no', pcr_fecal_positiva: 'no',
      hacinamiento: 'si', contacto_perro_infectado: 'si',
      raza_predispuesta: 'no', signos_respiratorios: 'no', signos_neurologicos: 'no',
    },
    variables: [
      { id: 'v1',  nombre: 'cachorro',                    label: '¿Es cachorro (< 1 año)?',                        tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v2',  nombre: 'no_vacunado',                 label: '¿Sin vacunación contra parvovirus?',             tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v3',  nombre: 'vacunado_hace_menos_14_dias', label: '¿Vacunado hace menos de 14 días?',              tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v4',  nombre: 'vomito',                      label: '¿Vómito presente?',                              tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v5',  nombre: 'diarrea_hemorragica',         label: '¿Diarrea hemorrágica?',                         tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v6',  nombre: 'diarrea_fetida',              label: '¿Diarrea fétida sin sangre?',                   tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v7',  nombre: 'letargia',                    label: '¿Letargia marcada?',                             tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v8',  nombre: 'anorexia',                    label: '¿Anorexia total?',                               tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v9',  nombre: 'fiebre_alta',                 label: '¿Fiebre > 39.5 °C?',                            tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v10', nombre: 'dolor_abdominal',             label: '¿Dolor abdominal a la palpación?',              tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v11', nombre: 'deshidratacion_severa',       label: '¿Deshidratación severa (> 8%)?',                tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v12', nombre: 'edad_6sem_a_6meses',          label: '¿Edad entre 6 semanas y 6 meses?',              tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v13', nombre: 'leucopenia_severa',           label: '¿Leucopenia severa (< 3000 leucocitos/µL)?',    tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v14', nombre: 'linfopenia',                  label: '¿Linfopenia en hemograma?',                     tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v15', nombre: 'neutropenia',                 label: '¿Neutropenia en hemograma?',                    tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v16', nombre: 'hipoglucemia',                label: '¿Hipoglucemia?',                                 tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v17', nombre: 'hipoalbuminemia',             label: '¿Hipoalbuminemia?',                             tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v18', nombre: 'antigeno_fecal_positivo',     label: '¿Antígeno fecal (ELISA/IC) positivo?',          tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v19', nombre: 'pcr_fecal_positiva',          label: '¿PCR fecal para parvovirus positiva?',          tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v20', nombre: 'hacinamiento',                label: '¿Vive en hacinamiento con otros perros?',       tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v21', nombre: 'contacto_perro_infectado',    label: '¿Contacto reciente con perro infectado?',       tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v22', nombre: 'raza_predispuesta',           label: '¿Raza predispuesta (Rottweiler/Doberman/Pit)?', tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v23', nombre: 'signos_respiratorios',        label: '¿Signos respiratorios presentes?',             tipo: 'booleano', conjuntos: [], opciones: [] },
      { id: 'v24', nombre: 'signos_neurologicos',         label: '¿Signos neurológicos presentes?',              tipo: 'booleano', conjuntos: [], opciones: [] },
    ],
    reglas: [
      // ── Confirmado — prueba diagnóstica
      { id: 'r1',  condiciones: [{ var: 'pcr_fecal_positiva', op: '==', val: 'si' }],
        conclusion: '🔴 CPV Confirmado — prueba diagnóstica positiva', peso: 0.99,
        explicacion: 'PCR fecal positiva: diagnóstico definitivo de CPV-2' },
      { id: 'r2',  condiciones: [
          { var: 'antigeno_fecal_positivo', op: '==', val: 'si' },
          { var: 'diarrea_hemorragica',     op: '==', val: 'si' },
          { var: 'cachorro',               op: '==', val: 'si' },
        ], conclusion: '🔴 CPV Confirmado — prueba diagnóstica positiva', peso: 0.97,
        explicacion: 'Antígeno ELISA/IC positivo + enteritis hemorrágica en cachorro' },
      { id: 'r3',  condiciones: [
          { var: 'antigeno_fecal_positivo', op: '==', val: 'si' },
          { var: 'letargia',               op: '==', val: 'si' },
          { var: 'anorexia',               op: '==', val: 'si' },
        ], conclusion: '🔴 CPV Confirmado — prueba diagnóstica positiva', peso: 0.95,
        explicacion: 'Antígeno positivo con síntomas sistémicos confirmatorios' },

      // ── Sospecha Alta
      { id: 'r4',  condiciones: [
          { var: 'cachorro',           op: '==', val: 'si' },
          { var: 'no_vacunado',        op: '==', val: 'si' },
          { var: 'diarrea_hemorragica', op: '==', val: 'si' },
          { var: 'vomito',             op: '==', val: 'si' },
          { var: 'letargia',           op: '==', val: 'si' },
        ], conclusion: '🔴 Sospecha Alta de Parvovirosis Canina', peso: 0.93,
        explicacion: 'Cachorro sin vacunar con gastroenteritis hemorrágica y letargia' },
      { id: 'r5',  condiciones: [
          { var: 'edad_6sem_a_6meses',   op: '==', val: 'si' },
          { var: 'no_vacunado',          op: '==', val: 'si' },
          { var: 'diarrea_hemorragica',  op: '==', val: 'si' },
          { var: 'deshidratacion_severa', op: '==', val: 'si' },
        ], conclusion: '🔴 Sospecha Alta de Parvovirosis Canina', peso: 0.91,
        explicacion: 'Franja etaria crítica (6 sem–6 meses), sin inmunizar, con deshidratación severa' },
      { id: 'r6',  condiciones: [
          { var: 'leucopenia_severa',   op: '==', val: 'si' },
          { var: 'diarrea_hemorragica', op: '==', val: 'si' },
          { var: 'cachorro',            op: '==', val: 'si' },
        ], conclusion: '🔴 Sospecha Alta de Parvovirosis Canina', peso: 0.90,
        explicacion: 'Leucopenia severa + enteritis hemorrágica: hallazgo patognomónico de CPV' },
      { id: 'r7',  condiciones: [
          { var: 'neutropenia',         op: '==', val: 'si' },
          { var: 'linfopenia',          op: '==', val: 'si' },
          { var: 'diarrea_hemorragica', op: '==', val: 'si' },
          { var: 'anorexia',            op: '==', val: 'si' },
        ], conclusion: '🔴 Sospecha Alta de Parvovirosis Canina', peso: 0.88,
        explicacion: 'Pancitopenia compatible con destrucción de células madre hematopoyéticas por CPV' },
      { id: 'r8',  condiciones: [
          { var: 'cachorro',                op: '==', val: 'si' },
          { var: 'contacto_perro_infectado', op: '==', val: 'si' },
          { var: 'diarrea_hemorragica',     op: '==', val: 'si' },
          { var: 'letargia',               op: '==', val: 'si' },
        ], conclusion: '🔴 Sospecha Alta de Parvovirosis Canina', peso: 0.89,
        explicacion: 'Exposición epidemiológica confirmada + cuadro hemorrágico en cachorro' },
      { id: 'r9',  condiciones: [
          { var: 'raza_predispuesta',   op: '==', val: 'si' },
          { var: 'no_vacunado',         op: '==', val: 'si' },
          { var: 'diarrea_hemorragica', op: '==', val: 'si' },
          { var: 'fiebre_alta',         op: '==', val: 'si' },
        ], conclusion: '🔴 Sospecha Alta de Parvovirosis Canina', peso: 0.87,
        explicacion: 'Raza genéticamente predispuesta sin inmunización con signos agudos' },
      { id: 'r10', condiciones: [
          { var: 'vacunado_hace_menos_14_dias', op: '==', val: 'si' },
          { var: 'diarrea_hemorragica',         op: '==', val: 'si' },
          { var: 'vomito',                      op: '==', val: 'si' },
          { var: 'letargia',                    op: '==', val: 'si' },
        ], conclusion: '🔴 Sospecha Alta de Parvovirosis Canina', peso: 0.85,
        explicacion: 'Vacuna reciente sin inmunidad consolidada (< 14 días) + signos clínicos' },

      // ── Sospecha Moderada
      { id: 'r11', condiciones: [
          { var: 'cachorro',        op: '==', val: 'si' },
          { var: 'diarrea_fetida',  op: '==', val: 'si' },
          { var: 'vomito',          op: '==', val: 'si' },
          { var: 'anorexia',        op: '==', val: 'si' },
          { var: 'dolor_abdominal', op: '==', val: 'si' },
        ], conclusion: '🟠 Sospecha Moderada de Parvovirosis Canina', peso: 0.76,
        explicacion: 'Síndrome gastroentérico en cachorro sin sangre — diferencial con entéricos inespecíficos' },
      { id: 'r12', condiciones: [
          { var: 'hacinamiento',             op: '==', val: 'si' },
          { var: 'contacto_perro_infectado', op: '==', val: 'si' },
          { var: 'diarrea_hemorragica',      op: '==', val: 'si' },
        ], conclusion: '🟠 Sospecha Moderada de Parvovirosis Canina', peso: 0.74,
        explicacion: 'Riesgo epidemiológico alto + enteritis hemorrágica sin datos de laboratorio' },
      { id: 'r13', condiciones: [
          { var: 'leucopenia_severa', op: '==', val: 'si' },
          { var: 'hipoglucemia',      op: '==', val: 'si' },
          { var: 'hipoalbuminemia',   op: '==', val: 'si' },
        ], conclusion: '🟠 Sospecha Moderada de Parvovirosis Canina', peso: 0.73,
        explicacion: 'Alteraciones bioquímicas compatibles con CPV — confirmar con prueba fecal' },
      { id: 'r14', condiciones: [
          { var: 'cachorro',        op: '==', val: 'si' },
          { var: 'diarrea_fetida',  op: '==', val: 'si' },
          { var: 'letargia',        op: '==', val: 'si' },
          { var: 'dolor_abdominal', op: '==', val: 'si' },
        ], conclusion: '🟠 Sospecha Moderada de Parvovirosis Canina', peso: 0.70,
        explicacion: 'Enteritis con letargia en cachorro — posible fase pre-hemorrágica de CPV' },
      { id: 'r15', condiciones: [
          { var: 'no_vacunado',             op: '==', val: 'si' },
          { var: 'contacto_perro_infectado', op: '==', val: 'si' },
          { var: 'fiebre_alta',             op: '==', val: 'si' },
          { var: 'vomito',                  op: '==', val: 'si' },
        ], conclusion: '🟠 Sospecha Moderada de Parvovirosis Canina', peso: 0.68,
        explicacion: 'Sin vacuna + exposición + fiebre y vómito — cuadro prodrómico de CPV' },
      { id: 'r16', condiciones: [
          { var: 'signos_neurologicos', op: '==', val: 'si' },
          { var: 'cachorro',            op: '==', val: 'si' },
          { var: 'diarrea_hemorragica', op: '==', val: 'si' },
        ], conclusion: '🟠 Sospecha Moderada de Parvovirosis Canina', peso: 0.71,
        explicacion: 'Forma miocárdica/neurológica infrecuente de CPV — confirmación urgente' },
      ...
      { id: 'r17', condiciones: [
          ...
          { var: 'letargia', op: '==', val: 'si' },
          { var: 'anorexia', op: '==', val: 'si' },
        ], conclusion: '🟡 Sospecha Baja de Parvovirosis Canina', peso: 0.52,
        explicacion: 'Signos inespecíficos en cachorro — diferencial amplio: gastroenteritis viral, intoxicación' },
      { id: 'r18', condiciones: [
          { var: 'no_vacunado',  op: '==', val: 'si' },
          { var: 'hacinamiento', op: '==', val: 'si' },
          { var: 'fiebre_alta',  op: '==', val: 'si' },
        ], conclusion: '🟡 Sospecha Baja de Parvovirosis Canina', peso: 0.48,
        explicacion: 'Riesgo ambiental + fiebre sin signos digestivos — vigilancia epidemiológica' },
      { id: 'r19', condiciones: [
          { var: 'contacto_perro_infectado', op: '==', val: 'si' },
          { var: 'vomito',                   op: '==', val: 'si' },
          { var: 'diarrea_fetida',           op: '==', val: 'si' },
        ], conclusion: '🟡 Sospecha Baja de Parvovirosis Canina', peso: 0.45,
        explicacion: 'Exposición epidemiológica + síntomas leves — posible fase inicial o infección subclínica' },
      { id: 'r20', condiciones: [
          { var: 'signos_respiratorios', op: '==', val: 'si' },
          { var: 'cachorro',             op: '==', val: 'si' },
          { var: 'no_vacunado',          op: '==', val: 'si' },
        ], conclusion: '🟡 Sospecha Baja de Parvovirosis Canina', peso: 0.42,
        explicacion: 'Presentación atípica respiratoria — diferencial con moquillo, bronquitis infecciosa canina' },
    ],
    clases: [],
  },
];
